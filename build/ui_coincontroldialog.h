...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DLISK"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DLISK"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DLISK"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DLISK"));
