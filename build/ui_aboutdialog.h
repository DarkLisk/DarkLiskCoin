...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About DarkLiskCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>DarkLiskCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The DarkLiskCoin developers", Q_NULLPTR));
